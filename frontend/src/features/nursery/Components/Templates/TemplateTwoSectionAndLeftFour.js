...
const TemplateTwoSectionAndLeftFour = ({ content, index, handelDeleteRendersUpload, handleImageUploadNurseryStore, mergedArrow, setIsModelOpen, setAtBlockIndex, setIsCurrentTemplates, isCurrentTemplates, setIsModelOpenEdit, setIsCurrentBlock }) => {
    ...
    return (
        <div className='col-12 col-md-11 px-2 px-md-0'>
            {
                content.length > 0 ?
                    <div className="p-0 template template-images template-half-left-two rounded w-100" >
                        <div className="template-half-left-two-second rounded d-flex flex-column w-100 h-100 rounded">
                            <div className="first w-100 h-100 d-flex justify-content-center rounded mb-1">
                            ...
                            <div className="second h-100 w-100 d-flex justify-content-center rounded">
                                <div className='rounded border border-black position-relative me-1 w-100'>
                                    {
                        ...
                        <div className="template-half-left-two-first rounded border border-black position-relative w-100">
                            {
                    ...
                    <div className="template template-half-left-two rounded hover-images position-relative">
                        <div className="template-half-left-two-second rounded d-flex flex-column w-100 h-100 rounded">
                            <div className="first mb-1 w-100 h-100 d-flex justify-content-center align-items-center rounded">
                                <div className="me-1 w-100 h-100 template-hover template-header rounded d-flex justify-content-center align-items-center hover-images bg-secondary" onClick={() => { setIsModelOpen(true); setAtBlockIndex(0); setIsCurrentTemplates(isCurrentTemplates) }}>
                                    <div className="template-header-complete rounded ">
                                        <p className='text-center user-select-none'><i className='fas fa-images'></i> Add Content</p>
                                    </div>
                                </div>
                                <div className="me-1 w-100 h-100 template-hover template-header rounded d-flex justify-content-center align-items-center hover-images bg-secondary" onClick={() => { setIsModelOpen(true); setAtBlockIndex(1); setIsCurrentTemplates(isCurrentTemplates) }}>
                                    <div className="template-header-complete rounded ">
                                        <p className='text-center user-select-none'><i className='fas fa-images'></i> Add Content</p>
                                    </div>
                                </div>
                            ...
                            <div className="second h-100 w-100 d-flex justify-content-center align-items-center rounded">
                                <div className="me-1 template-hover w-100 h-100 template-header rounded d-flex justify-content-center align-items-center hover-images bg-secondary" onClick={() => { setIsModelOpen(true); setAtBlockIndex(2); setIsCurrentTemplates(isCurrentTemplates) }}>
                                    <div className="template-header-complete rounded ">
                                        <p className='text-center user-select-none'><i className='fas fa-images'></i> Add Content</p>
                                    </div>
                                </div>
                                <div className="me-1 template-hover w-100 h-100 template-header rounded d-flex justify-content-center align-items-center hover-images bg-secondary" onClick={() => { setIsModelOpen(true); setAtBlockIndex(3); setIsCurrentTemplates(isCurrentTemplates) }}>
                                    <div className="template-header-complete rounded ">
                                        <p className='text-center user-select-none'><i className='fas fa-images'></i> Add Content</p>
                                    </div>
                                </div>
...
export default TemplateTwoSectionAndLeftFour